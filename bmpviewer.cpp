...
void BitmapViewer::UpdateBitmap()
{
    ...
    wxLogMessage("UpdateBitmap: current view pos before update = (%d, %d)", view_x, view_y);
...
void BitmapViewer::OnMouseDown(wxMouseEvent &event)
{
    ...
    wxLogMessage("MouseDown: view_origin=(%d, %d), pos=(%d, %d)", view_origin.x, view_origin.y, pos.x, pos.y);
...
{
    wxLogMessage("MouseUp: Ending drag");
...
void BitmapViewer::OnMouseMove(wxMouseEvent &event)
{
    ...
    wxLogMessage("MouseMove: from=(%d, %d), to=(%d, %d)", view_origin.x, view_origin.y, new_pos.x, new_pos.y);
...
void BitmapViewer::OnScrolling(wxScrollWinEvent &event)
{
    int x, y;
    GetViewStart(&x, &y);
    wxLogMessage("Scrolling: new view pos = (%d, %d)", x, y);
...
void BitmapViewer::OnSizeChanged(wxSizeEvent &event)
{
    ...
    wxLogMessage("SizeChanged: new size = (%d, %d)", sz.x, sz.y);
